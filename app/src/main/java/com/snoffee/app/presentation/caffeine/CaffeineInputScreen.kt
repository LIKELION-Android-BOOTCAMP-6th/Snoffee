...
private val dummyDrinks = listOf(
    DrinkItem("001", "아메리카노", "커피", "스타벅스", 125.0, 355.0, 125.0, 355.0, "ml"),
    DrinkItem("002", "라떼", "커피", "스타벅스", 75.0, 355.0, 75.0, 355.0, "ml"),
    DrinkItem("003", "에스프레소", "커피", "스타벅스", 63.0, 30.0, 63.0, 30.0, "ml"),
    DrinkItem("004", "콜드브루", "커피", "스타벅스", 155.0, 355.0, 155.0, 355.0, "ml"),
)
